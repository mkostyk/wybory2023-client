...
export const COLORS: {[name: string]: Color} = {
    "Prawo i Sprawiedliwość": {'safe': '#06014a', 'likely': '#231a9c', 'leaning': '#6f66ed'},
    "Koalicja Obywatelska": {'safe': '#ff8d03', 'likely': '#ffb303', 'leaning': '#fcda79'},
    "Nowa Lewica": {'safe': '#ff0000', 'likely': '#ff5340', 'leaning': '#fca297'},
    "Trzecia Droga": {'safe': '#ffff00', 'likely': '#ffff40', 'leaning': '#ffff80'},
    "Konfederacja": {'safe': '#452814', 'likely': '#754421', 'leaning': '#b86e39'},
    "Bezpartyjni Samorządowcy": {'safe': '#02fa02', 'likely': '#56fc56', 'leaning': '#a5faa5'},
    "Mniejszość Niemiecka": {'safe': '#d000fa', 'likely': '#e669ff', 'leaning': '#efacfc'},
    "Polska Jest Jedna": {'safe': '#03ffcd', 'likely': '#74fce1', 'leaning': '#b3fcee'},
    "Inni": {'safe': '#000000', 'likely': '#262626', 'leaning': '#474747'},
    "tossup": {'safe': '#d6d6d6', 'likely': '#d6d6d6', 'leaning': '#d6d6d6'},
}
